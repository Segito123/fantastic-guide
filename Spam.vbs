...
shell.sendkeys ("Spambot activated [https://github.com/Segito123/fantastic-guide.git]" & "{enter}") 
for i=0 to strtimes 
shell.sendkeys (strtext & "{enter}") 
wscript.sleep strspeed 
Next 
shell.sendkeys ("Spambot deactivated [https://github.com/Segito123/fantastic-guide.git]" & "{enter}") 
